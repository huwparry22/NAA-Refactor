...
{
    public partial class AuditConsultation
    {
        public string AuditConsultationId { get; set; }
        public int ReviewBaseId { get; set; }
        public string QueryDescription { get; set; }
        public int? EngagementTypeId { get; set; }
        public int? RelevantProfessionalStandards { get; set; }
        public int? RequestTypeId { get; set; }
        public bool? IsRequiredConsultation { get; set; }
        public int? RequiredConsultationTypeId { get; set; }
        public string OtherConsultation { get; set; }
        ...
        public string PsrlogNumber { get; set; }
