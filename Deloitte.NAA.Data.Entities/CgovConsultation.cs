...
{
    public partial class CgovConsultation
    {
        public string CgovConsultationId { get; set; }
        public int ReviewBaseId { get; set; }
        public string QueryDescription { get; set; }
        public bool? QueryRelateToFtse350entity { get; set; }
        public int? NatureOfEntity { get; set; }
        public int? TypeOfConsultationRequest { get; set; }
        public string FactsAndCircumstancesOfQuery { get; set; }
        public int? RequestTypeId { get; set; }
        public DateTime? PlannedSubmissionDate { get; set; }
        public DateTime? DesiredTimingOfCompletion { get; set; }
